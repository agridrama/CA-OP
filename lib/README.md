...
Below are the original README contents of the OmniPaxos library, which is used in our project. The original repository can be found at ![GitHub](https://github.com/haraldng/omnipaxos).

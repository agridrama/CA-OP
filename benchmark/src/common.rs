pub mod messages {
    use crate::omnipaxos_api::{messages::Message as OmniPaxosMessage, util::NodeId};
...
pub mod kv {
    use crate::omnipaxos_api::{macros::Entry, storage::Snapshot};
    use serde::{Deserialize, Serialize};
    use std::collections::HashMap;

    pub type CommandId = usize;
    pub type ClientId = u64;
    pub type NodeId = crate::omnipaxos_api::util::NodeId;
